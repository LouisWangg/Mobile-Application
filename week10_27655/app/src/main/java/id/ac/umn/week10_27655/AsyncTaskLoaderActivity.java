...
public class AsyncTaskLoaderActivity extends AppCompatActivity implements
                        ...
                        mActivity.get().runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                if(progress < 100) {
                                    ...
                                    mActivity.get().mTextView.setText("progress = " +
                                            progress + " persen");
                                } else {
                                    mActivity.get().mProgressBar.setProgress(100);
                                    mActivity.get().mTextView.setText("Selesai selama " +
