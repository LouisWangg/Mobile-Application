package id.ac.umn.week13_27655;
...
public class TambahObject extends FragmentActivity implements OnMapReadyCallback {
    ...
    // 0 = Marker; 1 = Circle; 2 = Polyline; 3 = Polygon private GoogleMap mMap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.tambahmap);
                ...
                switch(pilihan){
                    ...
                    case 3:
                        ...
                        if(titiks.size() == 1) {
                            ...
                            pg.add(titiks.get(0));
                            mMap.addPolygon(pg);
                            objMS = new MarkerDanShape("Polygon", etKeterangan.getText().toString(), 0, titiks);
                            btnSimpan.setEnabled(true);
                        }
                        break;
                }
